...
open class ExpandingMenuButton: UIView, UIGestureRecognizerDelegate {
    ...
    @objc open var expandingSoundPath: String = Bundle.main.path(forResource: "expanding", ofType: "caf") ?? "" {
        didSet {
            self.configureSounds()
        }
    }
    
    @objc open var foldSoundPath: String = Bundle.main.path(forResource: "fold", ofType: "caf") ?? "" {
        didSet {
            self.configureSounds()
        }
    }
    
    @objc open var selectedSoundPath: String = Bundle.main.path(forResource: "selected", ofType: "caf") ?? "" {
        didSet {
            self.configureSounds()
        }
    }
